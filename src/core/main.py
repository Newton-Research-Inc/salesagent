...
# Path-based routing middleware removed - using direct task IP connections instead
# (Middleware was causing "BaseHTTPMiddleware.__init__() got an unexpected keyword argument 'call_next'" errors)
